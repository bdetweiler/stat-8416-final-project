...
for (ii in seq(startindex, length(addresses))){
  ...
  if (ii %in% error_indexes) {
    result =  data.frame(lat=NA, long=NA, accuracy=NA, formatted_address=NA, address_type=NA, status='Error')
  } else {
    print(ii %in% error_indexes)
