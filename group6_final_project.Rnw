...
% Note: ColorPlethr is not available for R < 3.3
The entirety of this project is reproducible using \textsf{R} (version 3.3 and above) with the \texttt{Knitr} package. All code, including this document, is available through GitHub. \cite{GitHub}
